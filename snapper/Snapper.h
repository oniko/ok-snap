...
namespace snapper
{
	...
	Snapshots::iterator importSingleSnapshot(const string &description, unsigned char import_policy, const string &idata);
	Snapshots::iterator importPreSnapshot(const string &description, unsigned char import_policy, const string &idata);
	Snapshots::iterator importPostSnapshot(const string &description, Snapshots::const_iterator pre, unsigned char import_policy, const string &idata);
